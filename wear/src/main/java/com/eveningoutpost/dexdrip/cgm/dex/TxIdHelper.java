...
// ported from app's cgm/dex/TxIdHelper.java - handleTransmitterEntry() dropped since it needs
// GenericConfirmDialog, which is a phone-only UI dialog not present on wear
